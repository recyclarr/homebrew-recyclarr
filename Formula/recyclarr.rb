class Recyclarr < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d2ae070c3ed9b52c316212e48b6a7cf4cf9eb2b5fc8f16217bd66f8fcda35d9d"
    end
    on_intel do
      url "https://github.com/recyclarr/recyclarr/releases/download/v#{version}/recyclarr-osx-x64.tar.xz"
      sha256 "f71c75be676ee5eeed1b4651715613dbd306c70f027afb528d24733380ce6691"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "cacddabde30d2cb4e21bd143c51b95df088b3e1cfafbc6210124255162c52705"
    end
    on_intel do
      url "https://github.com/recyclarr/recyclarr/releases/download/v#{version}/recyclarr-linux-x64.tar.xz"
      sha256 "ed36515e12483e20761e743f80f21650e26eb175c348c94622dbe1bc2fdb983f"
    end
  end
